...
def run(args=None):
    ...
    np.save(os.path.join(labels_dir, f"{args.dataset}_train_labels.npy"), labels_train)
    np.save(os.path.join(labels_dir, f"{args.dataset}_val_labels.npy"), labels_val)
